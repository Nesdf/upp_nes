...
abstract class CBaseListView extends CWidget
{
	...
	{
		$emptyText=$this->emptyText===null ? Yii::t('zii','No hay resultados.') : $this->emptyText;
	...
	public function renderSummary()
	{
		...
		if($this->enablePagination)
		{
			...
			if(($summaryText=$this->summaryText)===null)
				$summaryText=Yii::t('zii','Se muestra {start}-{end} de 1 resultados.|Se muestra {start}-{end} de {count} resultados.',$total);
